...
/***********************************************************************************************************
Tasks:
1.  Build a Console Application project EXERCISE11_VTune for MxM_MULT_SEQ.c, MxM_MULT_SEQ.c.
2.  Build FIRST the project EXERCISE11_VTune.exe with RELEASE x86 option ONLY for MxM_MULT_SEQ.c
...
6.  Repeat step 4. Notice the results in the way presented in Read Me EXERCISE11_VTune.txt.
