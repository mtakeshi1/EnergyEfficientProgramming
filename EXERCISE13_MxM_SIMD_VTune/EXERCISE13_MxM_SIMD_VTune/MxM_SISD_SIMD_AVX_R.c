...
1.	Build VTune project EXERCISE13_MxM_SIMD_VTune
2.	Analyse FIRST EXERCISE13_MxM_SIMD_VTune.exe with the Intel's VTune Profiler 2021.3 tool. Notice the results
