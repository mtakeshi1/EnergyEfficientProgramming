...
*
*
** Name: VDP_SISDzuSIMD_float_DEBUG.c
** Date: Spring 2022
...
/***********************************************************************************************************
Tasks:
1.  Build a Console Application project EXERCISE12_VDP_VTune_SISD for  VSP_SISDzuSIMD_float_DEBUG.c for the function
	at code line 80 "1.	Sequentieller FLOAT Code".
2.  Build project EXERCISE12_VDP_VTune_SISD with DEBUG x86 option
