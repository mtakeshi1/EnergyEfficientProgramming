...
1.  Build a Console Application project EXERCISE13_MxM_SISD_VTune for MMxM_SISD_AVX_D.c
2.  Build project EXERCISE13_MxM_SISD_VTune with DEBUG x86 option
3.	Test EXERCISE13_MxM_SISD_VTune.exe with WinDbg at code line 150.
